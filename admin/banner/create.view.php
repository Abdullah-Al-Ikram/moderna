          ...
          ?>
              <form action="" method="POST">
                ...
                <div>
                  ...
                  <input type="btn_text" class="form-control mb-3" id="btn_text" name="btn_text" placeholder="Button Text">
                  <?php
                ...
                <div>
                  ...
                  <input type="btn_url" class="form-control mb-3" id="btn_url" name="btn_url" placeholder="Button URL">
                  <?php
